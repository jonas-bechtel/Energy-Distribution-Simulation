...
if 'JSROOTSYS' in os.environ:
    ...
    c.NotebookApp.extra_static_paths.append(os.path.join("C:/Program Files (x86)/ROOT", "js"))
    c.ServerApp.extra_static_paths.append(os.path.join("C:/Program Files (x86)/ROOT", "js"))
